...
# Run `pod lib lint lite_rt_for_flutter_libs_gpu_delegate_macos.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'lite_rt_for_flutter_libs_gpu_delegate_macos'
  s.version          = '0.0.1'
...
A new Flutter plugin project.
  ...
  # s.resource_bundles = {'lite_rt_for_flutter_libs_gpu_delegate_macos_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
